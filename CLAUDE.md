...
- `npm test` — vitest, **1404 tests** across TWO projects, all green as of 2026-07-30. `|node|` (pure logic) + `|dom|` (jsdom + axe, **10** files) — see `vite.config.ts` `test.projects`. Ratchet: never let the count drop (95→126→140→181→239→245→296→322→340→613→644→649→655→659→666→711→760→814→961→1084→1316→1354→1356→1365→1388→1393→**1404**). **S28 added +11** — the candidate set is only measurable if the
