...
**Unscheduled ideas live in `docs/ideas.md`, prioritized.** As of 2026-08-03 there is **no P0**, and **S33 closed §15** (the generator quality complaint) leaving §15b (per-room furniture quotas, P2) behind it. The head of the queue is now **§16, the Word-style resize/rotate handles the owner asked for in the same message.** Historical context follows. As of 2026-07-31 there was no P0 —
